...
export const VE_PWN_TOKEN_ABI = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: "address", name: "stakeBeneficiary", type: "address" },
    ],
    name: "withdrawStake",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  { inputs: [], name: "ApproveDisabled", type: "error" },
  { inputs: [], name: "DelegateBySigDisabled", type: "error" },
  { inputs: [], name: "DelegateDisabled", type: "error" },
  { inputs: [], name: "EpochStillRunning", type: "error" },
  { inputs: [], name: "InvalidAmount", type: "error" },
  { inputs: [], name: "InvalidLockUpPeriod", type: "error" },
  { inputs: [], name: "LockUpPeriodMismatch", type: "error" },
  { inputs: [], name: "NotStakeOwner", type: "error" },
  { inputs: [], name: "NothingToIncrease", type: "error" },
  {
    inputs: [
      { internalType: "uint256", name: "lastCalculatedEpoch", type: "uint256" },
    ],
    name: "PowerAlreadyCalculated",
    type: "error",
  },
  { inputs: [], name: "SameBeneficiary", type: "error" },
  {
  ...
  { inputs: [], name: "TransferFromDisabled", type: "error" },
  { inputs: [], name: "WithrawalBeforeLockUpEnd", type: "error" },
] as const;
