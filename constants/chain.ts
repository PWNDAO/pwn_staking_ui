...
export const getChainIdToToggleTo = (currentActiveChain: SupportedChain) => {
    switch (currentActiveChain) {
        ...
        case 11155111: 
            return 1
        default:
            throw new Error(`Unknown currentActiveChain value == ${currentActiveChain} in chainIdToToggleTo fn.`)
    }
}

export const toggleActiveChain = (currentActiveChain: SupportedChain) => {
    switchChain(wagmiAdapter.wagmiConfig, { chainId: getChainIdToToggleTo(currentActiveChain) })
}
