...
const metadata = {
  ...
  description:
    "Easily check and manage your PWN DAO staking and voting positions.",
...
const DEFAULT_ENABLED_CHAIN = Number(
  import.meta.env.VITE_PUBLIC_ENABLED_CHAIN_ID,
) as SupportedChain;

const viemChains = (import.meta.env.VITE_PUBLIC_SHOW_ONLY_MAINNET === "true"
  ? [CHAIN_SETTINGS[1].chain]
  : Object.values(CHAIN_SETTINGS).map(
      (chainSetting) => chainSetting.chain,
